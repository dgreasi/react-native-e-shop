...
import { CheckoutScreen, EntityScreen, TimeSlotPickerModalScreen, TimeSlotPickerScreen } from '~screens';
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Group>
        ...
        <Stack.Screen name={MAIN_ROUTES.TIME_SLOT_PICKER} component={TimeSlotPickerScreen} />
      </Stack.Group>
